...
[![](resources/icons/google-scholar-dark.svg){fig-alt="Link to my Google Scholar" width="50%"}](https://scholar.google.com/citations?hl=en&user=H45vLccAAAAJ&view_op=list_works&gmla=AKKJWFctSeG1-RPdHM1Sm6zw_pddPbBW_Q-LL5Oj-bJgbK4mEgjr4lTM7hprsdR1hMk-s2grckZTOogim9ha4lHJ){target="_blank"}
::::

:::: {.g-col-4 .g-col-xl-2 .m-2 .p-0}
[![](resources/icons/linkedin-dark.svg){fig-alt="Link to my LinkedIn" width="50%"}](https://au.linkedin.com/in/tormey-reimer){target="_blank"}
::::

:::: {.g-col-4 .g-col-xl-2 .m-2 .p-0}
[![](resources/icons/orcid-dark.svg){fig-alt="Link to my OrCID" width="50%"}](https://orcid.org/0000-0002-5983-2798){target="_blank"}
::::

:::: {.g-col-4 .g-col-xl-2 .m-2 .p-0}
[![](resources/icons/researchgate-dark.svg){fig-alt="Link to my ResearchGate" width="50%"}](https://www.researchgate.net/profile/Tormey-Reimer){target="_blank"}
::::

:::: {.g-col-4 .g-col-xl-2 .m-2 .p-0}
[![](resources/icons/landmark-solid-dark.svg){fig-alt="Link to my institution" width="50%"}](https://marinesocioecology.org/team/tormey-reimer/){target="_blank"}
::::

:::: {.g-col-4 .g-col-xl-2 .m-2 .p-0}
[![](resources/icons/github-dark.svg){fig-alt="Link to my Github" width="50%"}](https://github.com/stormeyseas){target="_blank"}
::::
:::
...
:::: {.grid .justify-content-space-evenly .align-items-center}
::: {.g-col-12}
#### [High prevalence of vaterite in sagittal otoliths causes hearing impairment in farmed fish](https://doi.org/10.1038/srep25249){target="_blank"}
:::
...
```
`r abs.1`... [Read more](https://doi.org/10.1038/srep25249){target="_blank"}
:::::

::::: {.g-col-12 .g-col-md-6}
:::: {.grid .justify-content-space-evenly .align-items-center}
::: {.g-col-12}
#### [Rapid growth causes abnormal vaterite formation in farmed fish otoliths](https://doi.org/10.1242/jeb.148056){target="_blank"}
:::
...
```
`r abs.2`... [Read more](https://doi.org/10.1242/jeb.148056){target="_blank"}
:::::
::::::
