...
keywords: computational biology, marine science, sustainability, bioremediation, seaweed aquaculture
author-meta: Dr Tormey Reimer
twitter:
  creator: "@stormeyseas"
  card-style: summary_large_image
  image: "resources/images/Bruny5x4.jpg"
---
...
<!-- ::::: {.g-col-4 .align-self-center} -->
<!-- :::: card -->
<!-- ![](resources/images/coding.jpg){.card-img-top fig-alt="Computer screen showing data analysis code"} -->
...
<!-- ::: card-text -->
<!-- Exploring how I use computational methods to understand marine ecosystems. -->
